...
sections:
  ...
  - block: markdown
    content:
      ...
      text: |-
        <div style="font-size: 1rem; text-align: left; width: 1000px; margin: 0 auto;">
          • S. Ding, J. P. Yalla, <strong>Y. Chen</strong>, "Demo abstract: RAG-driven 3D question answering in edge-assisted virtual reality," to appear in <i>Proc. IEEE INFOCOM</i>, May 2025.<br>
        </div>
        [Video of the demo](https://www.youtube.com/watch?v=bDrN5AWmKJA)
        ...
        <div style="font-size: 1rem; text-align: left; width: 1000px; margin: 0 auto;">
          ...
          • T. Hu, T. Scargill, <strong>Y. Chen</strong>, G. Lan, M. Gorlatova, "DNN-based SLAM tracking error online estimation," in <i>Proc. ACM MobiCom</i>, Oct. 2023.<br>
        </div>
        [Video of the demo](https://www.youtube.com/watch?v=bDrN5AWmKJA)

        <div style="font-size: 1rem; text-align: left; width: 1000px; margin: 0 auto;">
          • L. Duan, <strong>Y. Chen</strong>, M. Gorlatova, "Demo Abstract: BiGuide: A bi-level data acquisition guidance for object detection on mobile devices," in <i>Proc. ACM/IEEE IPSN</i>, May 2023.<br>
        </div>
        [Video of the demo](https://www.youtube.com/watch?v=bDrN5AWmKJA

        <div style="font-size: 1rem; text-align: left; width: 1000px; margin: 0 auto;">
          • <strong>Y. Chen</strong>, J. Sarik, H. Inaltekin, M. Gorlatova, "Demo: Demonstrating resource-efficient SLAM in virtual spacecraft environments," in <i>Proc. IEEE INFOCOM</i>, May 2023.<br>
        </div>
        [Video of the demo](https://www.youtube.com/watch?v=bDrN5AWmKJA)

        <div style="font-size: 1rem; text-align: left; width: 1000px; margin: 0 auto;">
          • <strong>Y. Chen</strong>, H. Inaltekin, M. Gorlatova, "Demo: Pixel similarity-based content reuse in edge-assisted virtual reality," in <i>Proc. IEEE INFOCOM</i>, May 2022.<br>
        </div>
        [Video of the demo](https://www.youtube.com/watch?v=bDrN5AWmKJA)
